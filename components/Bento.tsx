...
const cardBase =
  "rounded-card border border-lilac/[0.14] bg-surface p-6 transition-colors hover:border-lilac/40";
...
export default function Bento() {
  return (
    <section id="sobre" className="container-page relative py-[90px]">
      ...
      {/* Card de perfil à esquerda + grid bento.
          Acima de 1200px a linha é travada na altura do card (430px) e o grid
          divide esse espaço em 2 faixas iguais, senão o grid cresce conforme o
          texto quebra e o card da foto fica "flutuando" no meio.
          Abaixo disso empilha: com o card ocupando 320px, três colunas ficariam
          estreitas demais e o texto estouraria a altura travada. */}
      <div className="relative mt-9 flex items-stretch gap-4 max-[1200px]:flex-col min-[1201px]:h-[430px]">
        <ProfileCard />

        <div className="grid flex-1 grid-cols-3 gap-4 max-[900px]:grid-cols-2 max-[640px]:grid-cols-1 min-[1201px]:grid-rows-2">
          ...
          <div className={cardBase}>
            ...
            <div className="mt-1.5 text-[13.5px] leading-[1.7] text-txt-muted">
              Do banco de dados à interface final, sem depender de outras
              pessoas para entregar.
            </div>
          </div>
          ...
          <div className={cardBase}>
            ...
            <div className="mt-1.5 text-[13.5px] leading-[1.7] text-txt-muted">
              Entendo regras de negócio, fluxos e UX antes de escrever a
              primeira linha.
            </div>
          </div>

          {/* Bloco largo, ocupa duas colunas */}
          <div className="col-span-2 rounded-card border border-lilac/[0.18] bg-grad-bento p-6 transition-colors hover:border-lilac/45 max-[640px]:col-span-1">
